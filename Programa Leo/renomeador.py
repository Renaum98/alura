...
# ---------------------------------------
# Caminhos portáteis (Tesseract + Poppler)
# ---------------------------------------

# Detecta se está rodando como .py normal ou como .exe do PyInstaller
BASE_DIR = getattr(sys, "_MEIPASS", os.path.dirname(os.path.abspath(__file__)))

# Tesseract portátil (copiar a pasta Tesseract-OCR da sua máquina e renomear para "tesseract-portable")
TESSERACT_PATH = os.path.join(BASE_DIR, "tesseract-portable", "tesseract.exe")
pytesseract.pytesseract.tesseract_cmd = TESSERACT_PATH

# Poppler portátil (copiar a pasta bin e renomear para "poppler-portable/Libray/bin")
